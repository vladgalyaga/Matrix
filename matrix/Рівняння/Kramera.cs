    ...
    public partial class Form1 : Form
    {
       ...
       public int i = 0;
        ...
        private void Filling()
        {
            ...
            textBox10.Text =Convert.ToString(rnd.Next(BaseModel.MinValue, BaseModel.MaxValue) + Math.Round(rnd.NextDouble(), BaseModel.NumberOfDecimals));
            textBox11.Text =Convert.ToString(rnd.Next(BaseModel.MinValue, BaseModel.MaxValue) + Math.Round(rnd.NextDouble(), BaseModel.NumberOfDecimals));
            textBox12.Text = Convert.ToString(rnd.Next(BaseModel.MinValue, BaseModel.MaxValue) + Math.Round(rnd.NextDouble(), BaseModel.NumberOfDecimals));
